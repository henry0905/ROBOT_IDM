 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='pas_nom_meme up_down_autant'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot pas_nom_meme='Choreography.allInstances()-&gt;forAll(c1,c2|c1&lt;&gt;c2 implies c1.name&lt;&gt;c2.name)' up_down_autant='Choreography.allInstances()-&gt;select(e: Instruction | e.oclIsTypeOf(PenDown))-&gt;size() = Choreography.allInstances()-&gt;select(e: Instruction | e.oclIsTypeOf(PenUp))-&gt;size()'"
 * @generated
 */

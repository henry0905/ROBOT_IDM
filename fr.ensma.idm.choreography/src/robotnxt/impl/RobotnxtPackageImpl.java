	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (choreographyEClass,
		   source,
		   new String[] {
			   "constraints", "pas_nom_meme up_down_autant"
		   });
		addAnnotation
		  (turnLeftEClass,
		   source,
		   new String[] {
			   "constraints", "angle_positif"
		   });
		addAnnotation
		  (turnRightEClass,
		   source,
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (choreographyEClass,
		   source,
		   new String[] {
			   "pas_nom_meme", "Choreography.allInstances()->forAll(c1,c2|c1<>c2 implies c1.name<>c2.name)",
			   "up_down_autant", "Choreography.allInstances()->select(e: Instruction | e.oclIsTypeOf(PenDown))->size() = Choreography.allInstances()->select(e: Instruction | e.oclIsTypeOf(PenUp))->size()"
		   });
		addAnnotation
		  (turnLeftEClass,
		   source,
		   new String[] {
			   "angle_positif", "angle > 0 and angle < 180"
		   });
		addAnnotation
		  (turnRightEClass,
		   source,
